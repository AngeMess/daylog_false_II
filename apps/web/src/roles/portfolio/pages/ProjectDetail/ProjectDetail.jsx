...
import { ArrowLeft, Calendar, Clock, MapPin, Users, PenLine, X, Hash, FileText, AlertCircle, Loader, FileText as ReportIcon } from 'lucide-react';
        ...
        <Button
            ...
            <Button
              ...
              onClick={() => {
                ...
                console.log('Generando reporte para el proyecto:', proyecto?.nombre);
